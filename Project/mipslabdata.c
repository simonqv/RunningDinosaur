...
const uint8_t const icon[] = {
	...
	184, 69, 186, 69, 254, 80, 1, 1,
};

const uint8_t const bob[] = {
	251, 251, 225, 164, 128, 224, 128, 164, 225, 251, 251, 
	//32, 32, 120, 234, 254, 248, 254, 234, 120, 32, 32,
};

// DISPLAY Constants
//IMAGE SIZES
const int bob_height = 1;
const int bob_width = 11;

const int icon_height = 4;
